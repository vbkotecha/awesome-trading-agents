...
- [rnikitin/QuantGPT](https://github.com/rnikitin/QuantGPT) - 量化交易者与研究员的 AI 副驾驶；2023 年较早项目，仍在维护。
- [HKUSTDial/DeepEar](https://github.com/HKUSTDial/DeepEar) - "顺风耳"；HKUST-Dial 实验室开源的金融深度研究与信号跟踪框架；多模态新闻 + 价格联合追踪。
...
欢迎社区贡献新项目、移除失效链接，或讨论分类怎么改更清楚。请先阅读 [CONTRIBUTING.md](CONTRIBUTING.md)：质量门槛、提交格式和双语 PR 7 天处理说明都在那里。新项目建议用 [Issue: 添加条目](.github/ISSUE_TEMPLATE/add-entry.md) 模板；移除项目用 [Issue: 移除条目](.github/ISSUE_TEMPLATE/remove-entry.md) 模板。
