...
- 跨分类项目只在主归属章节完整列一次；次要视角确实有帮助时，用短回链即可。
- fork 关系、同作者关系、搭配关系，只在能帮助读者导航时写。
- 维护者推荐的首读项目放在 "如果你只读三个" 区块，不要给每条都加徽标。
- 不要在 README 条目行内加入每个项目的 stars、活动日期或临时维护标签。
...
稳定 `<a id>` 锚点、双语镜像、紧凑 pairing 说明、跨分类回链、图片 header。
...
讨论时请保持尊重、善意推断，尽量聚焦技术和清单维护问题。若讨论变成人身化、重复拉扯，
或偏离如何改进清单，维护者可能会关闭相关 thread。

## 11. 许可证说明

本清单文本、内容结构、README、贡献指南，以及贡献者提交到本仓库的 PR 文本，均以
